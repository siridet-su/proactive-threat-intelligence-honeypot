        ...
        <section id="capabilities" aria-labelledby="capabilities-title" className="mx-auto w-full max-w-7xl scroll-mt-24 px-6 py-16 sm:px-10 lg:py-20">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            {[
              ...
              <ScrollReveal key={item.title} delay={index * 45} className="h-full">
                <Link href={item.href} className="ui-panel ui-panel-interactive group flex h-full min-h-52 flex-col p-5 focus-visible:border-primary sm:p-6">
