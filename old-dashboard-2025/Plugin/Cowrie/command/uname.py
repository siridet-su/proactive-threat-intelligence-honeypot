...
# /home/cowrie/cowrie/src/cowrie/commands
...
def kernel_version() -> str:
    return CowrieConfig.get("shell", "kernel_version", fallback="5.4.0-155-generic")


def kernel_build_string() -> str:
    return CowrieConfig.get(
        "shell", "kernel_build_string", fallback="#43~20.04.1-Ubuntu SMP Fri May 5 18:23:44 UTC 2023 x86_64 GNU/Linux"
    )
