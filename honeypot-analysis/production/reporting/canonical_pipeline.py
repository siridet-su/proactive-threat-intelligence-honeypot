...
``session_assessment.v5``.  It deliberately contains no v1/v2/v3/v4 report
...
from production.reporting.session_assessment_v5 import build_session_assessment_v5
...
class CanonicalAssessmentCoordinator:
    """Build exactly one deterministic v5 assessment for a closed session."""
