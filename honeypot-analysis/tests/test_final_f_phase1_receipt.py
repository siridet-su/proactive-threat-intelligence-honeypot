...
RECEIPT_PATH = (
    PROJECT_ROOT
    / "evaluation"
    / "final_f_phase1_canonical_authority_receipt.v1.json"
)


def test_phase1_canonical_authority_receipt_is_content_addressed() -> None:
    receipt = json.loads(RECEIPT_PATH.read_text(encoding="utf-8"))
    assert receipt["schema_version"] == (
        "final_f_phase1_canonical_authority_receipt.v1"
    )
